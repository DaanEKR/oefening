                  ...
                  <!--RESERVERINGEN-->
                   <li class="dropdown">
                    <a 	href="#" 
                              ...
                              role="button" 
                              aria-haspopup="true" 
                              aria-expanded="false">Reserveringen <span class="caret"></span>
                    </a>
                         <ul class="dropdown-menu">
                           <li><a href="reserveringenvandaag.php">Vandaag</a></li>
                           <li><a href="reserveringen.php">alle reserveringen</a></li>
                         </ul>
                  </li>                  
                   <!--BESTELLINGEN
                  <li class="">
                  ...
                  <li class="dropdown">
                    <a 	href="overzichten.php" 
                         ...
                         <ul class="dropdown-menu">
                           ...
                           <li><a href="overzichten.php?overzicht=barman">Voor barman</a></li>
